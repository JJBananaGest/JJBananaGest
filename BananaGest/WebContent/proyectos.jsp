                ...
                <section>
                    <div class="tabla">
                         <div class="fila-tabla row">
                            <div class="col-xs-4 col-sm-6 col-md-12 bct">Proyectos</div>
                        </div>                        
                        ...
                        <div class="fila-tabla  row" id="1">
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-2">
                                ...
                                <button class="guard" id= "guarda1r" aria-label="Este botón sirve para guardar el responsable">guardar</button>
                        ...
                        <div class="fila-tabla  row" id="2" >
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-2">
                                ...
                                <button type="reset" class="edit" aria-label="boton para editar proyecto">Editar</button>
                                <button class="guard" id= "guarda2r" aria-label="Este botón sirve para guardar el responsable">guardar</button>
                        ...
                        <div class="fila-tabla  row" id="3">
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-2">
                                ...
                                <button type="reset" class="edit" aria-label="boton para editar proyecto">Editar</button>
                                <button class="guard" id= "guarda3r" aria-label="Este botón sirve para guardar el responsable">guardar</button>
