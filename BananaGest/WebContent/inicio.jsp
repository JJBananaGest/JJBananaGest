                ...
                <div class="col-xs-12 col-md-4 login">
                    <form class="form-inline" action="proyectos.jsp" method="POST" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" placeholder ="Password" required aria-label="Aquí se introduce la contraseña">
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 section">
                ...
                <section>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur saepe soluta eum molestias ullam
                        molestiae maxime quam assumenda, maiores illum necessitatibus obcaecati, tempore aperiam minima placeat
                        veniam ab harum, ducimus.
                    </p>
                </section>
            </div> 
        </div>
